...
export namespace Config {
  ...
  // testagent_change start: define Model schema for config validation (similar to opencode)
  ...
  // testagent_change start: define Provider schema from scratch like opencode (not using ModelsDev.Provider)
  export const Provider = z
    .object({
      ...
      models: z.record(z.string(), Model.nullable()).optional(),
      options: z
        .object({
  ...
  export const Info = z
    .object({
      ...
      shell: z.string().optional().describe("Default shell to use for terminal and bash tool"), // testagent_change
