...
通过 OpenCode，你可以配置 API 密钥来使用任意 LLM 模型API。

如果你刚开始接触 LLM 模型API，我们推荐使用 [OpenCode Zen](/docs/zen)。这是一组经过 OpenCode 团队测试和验证的精选模型。
...
你也可以选择其他模型API。[了解更多](/docs/providers#directory)。

---

## 初始化

配置好模型API后，导航到你想要处理的项目目录。
