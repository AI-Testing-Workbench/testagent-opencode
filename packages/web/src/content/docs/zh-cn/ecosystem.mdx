...
| [opencode-websearch-cited](https://github.com/ghoulr/opencode-websearch-cited.git)                 | 为受支持的模型API添加原生网页搜索支持，采用 Google grounded 风格        |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 模型API，用于通过 @opencode-ai/sdk 使用 OpenCode |
