...
export const dict = {
  ...
  "error.providerRequired": "缺少模型API",
  ...
  "temp.feature.models.beforeLink": "通过 Models.dev 支持 75+ LLM 模型API",
  ...
  "home.hero.subtitle.a": "内置免费模型，或连接任意模型API的任意模型，",
  ...
  "home.what.anyModel.body": "通过 Models.dev 支持 75+ LLM 模型API，包括本地模型",
  ...
  "home.faq.a3.p3": "虽然我们鼓励使用 Zen，但 OpenCode 也支持所有主流模型API，如 OpenAI, Anthropic, xAI 等。",
  "home.faq.a3.p4.beforeLocal": "您甚至可以连接您的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "我可以使用现有的 AI 订阅吗？",
  "home.faq.a4.p1":
    "可以，OpenCode 支持所有主流模型API的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, 或 GitHub Copilot 订阅。",
  ...
  "home.faq.a6": "OpenCode 是 100% 免费使用的。它还自带一组免费模型。如果您连接其他模型API，可能会产生额外费用。",
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 OpenCode 专门针对编程代理的测试和基准测试。无需担心不同模型API之间不稳定的性能和质量，直接使用行之有效的验证模型。",
  ...
  "zen.faq.q3": "Zen 更便宜吗？",
  "zen.faq.a3":
    "Zen 不以盈利为目的。Zen 将模型模型API的成本直接传递给您。Zen 的使用量越高，OpenCode 就越能协商出更好的费率并回馈给您。",
  "zen.faq.q4": "Zen 多少钱？",
  "zen.faq.a4.p1.beforePricing": "Zen",
  "zen.faq.a4.p1.pricingLink": "按请求收费",
  "zen.faq.a4.p1.afterPricing": "零加价，所以您只需支付模型模型API收取的费用。",
  ...
  "zen.faq.q5": "数据和隐私如何？",
  "zen.faq.a5.beforeExceptions": "所有 Zen 模型均托管在美国。模型API遵循零留存政策，不使用您的数据进行模型训练，",
  ...
  "zen.problem.body": "市面上有太多模型，但只有少数能与编程代理良好配合。大多数模型API配置不同，导致结果参差不齐。",
  "zen.problem.subtitle": "我们要为所有人解决这个问题，不仅仅是 OpenCode 用户。",
  "zen.problem.item1": "测试精选模型并咨询其团队",
  "zen.problem.item2": "与模型API合作确保正确交付",
  "zen.problem.item3": "对所有推荐的模型-模型API组合进行基准测试",
  ...
  "zen.privacy.beforeExceptions": "所有 Zen 模型均托管在美国。模型API遵循零留存政策，不使用您的数据进行模型训练，",
  ...
  "go.privacy.beforeExceptions": "Go 模型托管在美国。模型API遵循零留存政策，不使用您的数据进行模型训练，",
  ...
  "go.faq.q5": "数据和隐私如何？",
  "go.faq.a5.body":
    "该计划主要面向国际用户设计，模型部署在美国、欧盟和新加坡，以确保稳定的全球访问。我们的模型API遵循零留存政策，不使用您的数据进行模型训练。",
  "go.faq.a5.beforeExceptions": "Go 模型托管在美国。模型API遵循零留存政策，不使用您的数据进行模型训练，",
  ...
  "zen.api.error.noProviderAvailable": "没有可用的模型API",
  "zen.api.error.providerNotSupported": "不支持模型API {{provider}}",
  ...
  "workspace.newUser.feature.quality.body": "访问配置为最佳性能的模型 - 无需降级或路由到更便宜的模型API。",
  "workspace.newUser.feature.lockin.title": "无锁定",
  "workspace.newUser.feature.lockin.body":
    "将 Zen 与任何编程代理结合使用，并在需要时继续在 OpenCode 中使用其他模型API。",
  ...
  "workspace.providers.subtitle": "配置您自己的 AI 模型API API 密钥。",
  ...
  "workspace.providers.table.provider": "模型API",
  ...
  "workspace.lite.subscription.selectProvider":
    "在你的 opencode 配置中选择「OpenCode Go」作为模型API，即可使用 Go 模型。",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 OpenCode 连接到付费模型API，您需要 AI 订阅，尽管您可以配合",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免费使用。虽然我们鼓励用户使用",
  "download.faq.a3.afterZen": "，但 OpenCode 支持所有主流模型API，如 OpenAI, Anthropic, xAI 等。",

  "download.faq.a5.p1": "OpenCode 是 100% 免费使用的。",
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型模型API的订阅。虽然 OpenCode 支持任何模型模型API，但我们建议使用",
  ...
  "enterprise.faq.a4":
    "是的。OpenCode 不存储您的代码或上下文数据。所有处理均在本地进行，或通过直接 API 调用您的 AI 模型API。通过集中配置和 SSO 集成，您的数据始终保留在您组织的基础设施内。",
