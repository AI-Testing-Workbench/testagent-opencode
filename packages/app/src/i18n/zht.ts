...
export const dict = {
  ...
  "provider.custom.description.prefix": "設定與 OpenAI 相容的模型API。請參閱",
  ...
  "settings.providers.section.connected": "已連線的模型API",
  "settings.providers.connected.empty": "沒有已連線的模型API",
  "settings.providers.section.popular": "熱門模型API",
