...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 TestAgent Zen 或 API 密钥连接",
  ...
  "provider.connect.opencodeZen.line1": "TestAgent Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.custom.description.prefix": "配置与 OpenAI 兼容的模型API。请查看",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Test 服务器。",
  ...
  "settings.general.row.colorScheme.description": "选择 TestAgent 跟随系统、浅色或深色主题",
  ...
  "settings.providers.custom.description": "通过基础 URL 添加与 OpenAI 兼容的模型API。",
